# -*- coding: utf-8 -*-
#
# Cookie Control documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 13 Apr 2016 15:29:36 +0530.
#
...
project = u'Cookie Control'
copyright = u'2016, Azeef A S,Sivaprasad S'
...
htmlhelp_basename = 'cookie_controldoc'
...
latex_documents = [
    ('Index', 'cookie_control.tex', u'Cookie Control',
     u'Azeef A S,Sivaprasad S', 'manual'),
]
...
pdf_documents = [
    ('Index', 'cookie_control', u'Cookie Control',
     u'Azeef A S,Sivaprasad S'),
]
...
texinfo_documents = [
    ('Index', 'cookie_control', u'Cookie Control',
     u'Azeef A S,Sivaprasad S', 'Cookie Control', 'One line description of project.',
     'Miscellaneous'),
]
